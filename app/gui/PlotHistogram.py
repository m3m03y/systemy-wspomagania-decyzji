...
class DisplayHistogram(QDialog):
    def __init__(self, x_name, classes, data):
        ...
        self.discretize_input.setLayout(discretize_layout)
        ...
        layout.addWidget(self.enable_discretize)
        discretize_layout.addWidget(QLabel("Choose division number:"))
        discretize_layout.addWidget(self.division_number)

        layout.addWidget(self.discretize_input)
